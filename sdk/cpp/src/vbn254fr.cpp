...
void vbn254fr_class::assert_equal(const vbn254fr_class& a, const vbn254fr_class& b) {
...
void oblivious_if(vbn254fr_class& out,
                  bool cond,
                  const vbn254fr_class& t,
                  const vbn254fr_class& f)
{
    vbn254fr_class cond_vec = uint32_t(cond);
    vbn254fr_mux(out.data(), cond_vec.data(), f.data(), t.data());
}
